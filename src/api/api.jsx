...
const googleMapsAPI = axios.create({
  ...
  export const fetchAllFood = (location,GOOGLE_MAPS_APIKEY ) => {
    let path = 
      `nearbysearch/json?keyword=food&location=${location.latitude}%2C${location.longitude}&radius=2000&type=restaurant&opennow=true&key=${GOOGLE_MAPS_APIKEY }`;
  ...
  export const fetchAllPOI = (location, GOOGLE_MAPS_APIKEY ) => {
    let POIpath =
    `nearbysearch/json?keyword=&location= 53.4721833%2C-2.238595&radius=2000&type=tourist_attraction|park&key=${GOOGLE_MAPS_APIKEY }`;
